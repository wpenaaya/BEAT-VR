...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_drumGame p_drumGame;
        ...
        public static SteamVR_Input_ActionSet_drumGame drumGame
        {
            get
            {
                return SteamVR_Actions.p_drumGame.GetCopy<SteamVR_Input_ActionSet_drumGame>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_drumGame = ((SteamVR_Input_ActionSet_drumGame)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_drumGame>("/actions/drumGame")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.drumGame};
        }
    }
}
